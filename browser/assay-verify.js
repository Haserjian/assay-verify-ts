...
var JURISDICTION_RECEIPT_SCHEMA = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://assay.local/schemas/jurisdiction_receipt.schema.json",
  title: "Guardian Jurisdiction Receipt",
  description: "Portable public contract for Guardian jurisdiction_loss receipts. The verifier validates receipt shape and authority permissions only.",
  type: "object",
  additionalProperties: false,
  required: [
    "receipt_type",
...
// src/schema-validation.ts
var Ajv2020 = Ajv2020Module.default;
var ajv = new Ajv2020({
  allErrors: true,
  strict: false,
...
var validateManifestFn = ajv.compile(PACK_MANIFEST_SCHEMA);
var validateJurisdictionReceiptFn = ajv.compile(JURISDICTION_RECEIPT_SCHEMA);
var validateAttestationFn = ajv.getSchema(ATTESTATION_SCHEMA.$id);
...
function instancePathToField(instancePath) {
  if (!instancePath) return void 0;
  return instancePath.split("/").slice(1).map((part) => part.replace(/~1/g, "/").replace(/~0/g, "~")).join(".");
}
...
function collectValidationErrors(validator, value) {
  if (validator(value)) {
    return [];
  }
...
function validateJurisdictionReceiptSchema(receipt) {
...
var SIGNATURE_FIELDS_V0 = /* @__PURE__ */ new Set([
  "anchor",
  "cose_signature",
  "receipt_hash",
  "signature",
...
var MANIFEST_SIGNING_EXCLUSIONS = /* @__PURE__ */ new Set(["signature", "pack_root_sha256"]);
...
function verifyPack(pack) {
  ...
  const expectedFiles = Array.isArray(manifest.expected_files) ? manifest.expected_files : [];
  ...
  if (expectedCount !== void 0 && receipts.length !== expectedCount) {
    errors.push({
